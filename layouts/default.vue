    ...
    >
      <v-list>
        ...
        >
          ...
          <v-list-item-content>
            <v-list-item-title class="d-flex justify-space-between align-center">Cart<v-chip v-if="basket && basket.length">{{basket.length}}</v-chip> <v-chip v-else>0</v-chip></v-list-item-title>
